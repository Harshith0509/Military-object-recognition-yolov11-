...
🚀 Features
YOLOv11 model training & inference inside Jupyter Notebook

Custom dataset for military object detection

Real-time detection from videos, webcam streams, and images

Dataset preprocessing, annotation, and augmentation

Performance evaluation: mAP, precision, recall, confusion matrix

Fully compatible with Google Colab and local GPU setups
